		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapuiauxiliar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapuiauxiliar-display": {
								"semanticObject": "comsapuiauxiliar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.uiauxiliar",
									"url": sap.ui.require.toUrl("com/sap/uiauxiliar")
								}
							}
						}
					}
