		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "kpi",
									"targetURL": "#comsapuidinamico-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapuidinamico-display": {
								"semanticObject": "comsapuidinamico",
								"action": "display",
								"description": "kpi de prueba asociado a servicio",
								"title": "kpi",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.uidinamico",
									"url": sap.ui.require.toUrl("com/sap/uidinamico")
								}
							}
						}
					}
