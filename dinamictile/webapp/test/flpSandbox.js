		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dinamic Tile",
									"targetURL": "#html5dinamictile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"html5dinamictile-display": {
								"semanticObject": "html5dinamictile",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=html5.dinamictile",
									"url": sap.ui.require.toUrl("html5/dinamictile")
								}
							}
						}
					}
