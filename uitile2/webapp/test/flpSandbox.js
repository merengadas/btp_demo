		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "tile2",
									"targetURL": "#nptile2uitile2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nptile2uitile2-display": {
								"semanticObject": "nptile2uitile2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nptile2.uitile2",
									"url": sap.ui.require.toUrl("nptile2/uitile2")
								}
							}
						}
					}
